      ...
      <div class="ticket-content">
        ...
        <div class="block-tikets" v-for="(ticket, index) in getAllTickets" :key="index">
          <div class="card" style="width: 18rem;">
            <img :src="require('@/assets/tickets_image/'+ticket.specialty.pre_path)" class="card-img-top" alt="logo ticket" v-if="ticket.specialty.pre_path">
            <img src="@/assets/tickets_image/placeholder.png" class="card-img-top" alt="placeholder" v-else>
            <div class="card-body">
            ...
            <ul class="list-group list-group-flush" id="ticket-list">
              <li class="list-group-item">Час проходження білета: {{ ticket.time_of_passing / 60 }}хв</li>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <input type="number" class="form-control" placeholder="наприклад 60" v-model="form.timeOfPassing">
              <label for="basic-url">Загальна кількість питань</label>
              <input type="number" class="form-control" placeholder="наприклад 20" v-model="form.countQuestion">
              <label for="basic-url">Спеціальність</label>
              <select class="form-control" v-model="form.idSpecialty">
...
export default {
  ...
  methods: {
    ...
    selectSpecialtyFilter (event) {
      this.selectSpecialty = parseInt(event.target.options[event.target.selectedIndex].value)
    },
    ...
    selectTicket (ticket = {}) {
      ...
      if (!isEmpty(this.activeTicket)) {
        ...
        this.form.timeOfPassing = this.activeTicket.time_of_passing
        this.form.countQuestion = this.activeTicket.count_question
        this.form.idSpecialty = this.activeTicket.id_specialty
      } else {
        this.form.title = ''
        this.form.timeOfPassing = 60
        this.form.countQuestion = 20
        this.form.idSpecialty = 0
      }
    },
    saveTicket () {
      console.log('save')
